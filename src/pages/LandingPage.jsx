...
const TESTIMONIALS = [
  { name: 'Paul M.', role: 'Build a static website', rating: 5, avatar: '/testimonials/paul.webp', review: 'I hired Creatisk to build a simple website. They kept it clean, elegant and exactly what I wanted. They are courteous, prompt and understood my needs. Swift changes and creative content. Very impressed.' },
  { name: 'Steve O.', role: 'Interactive Website Brochure', rating: 5, avatar: '/testimonials/steve_o.webp', review: '5* Performance. Creatisk understood project requirements, they had excellent communication and I would happily employ them to work on future projects. Thank you.' },
  { name: 'Pascal K.', role: 'E-commerce Platform', rating: 5, avatar: '/testimonials/pascal.webp', review: 'All went perfectly. Creatisk is very efficient and communicative. The project was delivered ahead of schedule with top quality.' },
  ...
  { name: 'Geoff T.', role: 'Auction Site Platform', rating: 5, avatar: '/testimonials/geoff.webp', review: 'I came back to Creatisk due to their work on a prior project, and they did not disappoint again. Great work and extremely reliable.' },
